...
<!--        </div>-->
    ...
    <section class="grid margin">
        <div class="s-9 center">
            <a href="/kufs/mongolia" class="s-12 m-6 l-3 padding vertical-center margin-bottom text-white text-size-25 text-strong <?=$year == '2016' ? 'background-aqua' : 'background-blue'?>" style="cursor: pointer">2016</a>
            <a href="/kufs/mongolia/2017" class="s-12 m-6 l-3 padding vertical-center margin-bottom text-white text-size-25 text-strong background-blue" style="cursor: pointer">2017</a>
        </div>
    </section>
    ...
    <section class="grid">
        ...
        <div class="s-9 m-9 center swiper mySwiper">
